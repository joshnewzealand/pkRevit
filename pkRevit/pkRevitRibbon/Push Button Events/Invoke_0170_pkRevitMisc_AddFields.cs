    ...
    public class Invoke_0170_pkRevitMisc_AddFields : IExternalCommand //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                if (!bool_Found)  
                {
                    RibbonSupportMethods.writeDebug("Invoke_0170_pkRevitMisc_AddFields" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
       ...
       // string dllModuleFolder = "pkRevitMisc"; //<--------------------------------------------- edit here
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                {
                    RibbonSupportMethods.writeDebug("DevInvoke_0170_pkRevitMisc_AddFields" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
            ...
            {
                string pathPreHeader = "DevInvoke_0170_pkRevitMisc_AddFields" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException + Environment.NewLine + Environment.NewLine;//<--------------------------------------------- edit here
