...
namespace pkRevitRibbon
{
    ...
    public class Invoke_0140_pkRevitMisc_RotatePlatform : IExternalCommand //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                string strCommandName = "ThisApplication_RotatePlatform"; //<--------------------------------------------- edit here
            ...
            {
                RibbonSupportMethods.writeDebug("Invoke_0140_pkRevitMisc_OpenParentView" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException, true);//<--------------------------------------------- edit here
            }
            finally
            {
            }
    ...
    [Autodesk.Revit.Attributes.Transaction(Autodesk.Revit.Attributes.TransactionMode.Manual)]
    public class DevInvoke_0140_pkRevitMisc_RotatePlatform : IExternalCommand  //<--------------------------------------------- edit here
    {
