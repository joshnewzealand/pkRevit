...
namespace pkRevitRibbon
{
    ...
    public class Invoke_0130_pkRevitMisc_SelectReferencePoint : IExternalCommand //<--------------------------------------------- edit here
    {
        //I count 1,5 = 6 places that need to change

        string dllModuleName = "pkRevitUnderstandingTransforms.dll"; //<--------------------------------------------- edit here
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                string strCommandName = "ThisApplication_SelectReferencePoint"; //<--------------------------------------------- edit here
                string strCommandName_Method = "StartMethod_0130"; //<--------------------------------------------- edit here
                ...
                if (!bool_Found)  
                {
                    RibbonSupportMethods.writeDebug("Invoke_0130_pkRevitMisc_SelectReferencePoint" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
            ...
            {
                RibbonSupportMethods.writeDebug("Invoke_0130_pkRevitMisc_OpenParentView" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException, true);//<--------------------------------------------- edit here
            }
            finally
            {
            }
    ...
    [Autodesk.Revit.Attributes.Transaction(Autodesk.Revit.Attributes.TransactionMode.Manual)]
    public class DevInvoke_0130_pkRevitMisc_SelectReferencePoint : IExternalCommand  //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                {
                    RibbonSupportMethods.writeDebug("DevInvoke_0130_pkRevitMisc_SelectReferencePoint" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
            ...
            {
                string pathPreHeader = "DevInvoke_0130_pkRevitMisc_SelectReferencePoint" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException + Environment.NewLine + Environment.NewLine;//<--------------------------------------------- edit here
