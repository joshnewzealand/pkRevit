...
namespace pkRevitRibbon
{
    ...
    public class Invoke_0190_pkRevitMisc_UnderStandingTransforms : IExternalCommand //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                string strCommandName = "ThisApplication_UnderstandingSliders"; //<--------------------------------------------- edit here
    ...
    [Autodesk.Revit.Attributes.Transaction(Autodesk.Revit.Attributes.TransactionMode.Manual)]
    public class DevInvoke_0190_pkRevitMisc_UnderStandingTransforms : IExternalCommand  //<--------------------------------------------- edit here
    {
