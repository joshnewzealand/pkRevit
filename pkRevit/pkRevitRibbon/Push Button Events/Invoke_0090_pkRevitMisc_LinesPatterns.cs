...
namespace pkRevitRibbon
{
    ...
    public class Invoke_0090_pkRevitMisc_LinesPatterns : IExternalCommand //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                string strCommandName_Method = "StartMethod_0090_Patterns"; //<--------------------------------------------- edit here
                ...
                if (!bool_Found)  
                {
                    RibbonSupportMethods.writeDebug("Invoke_0090_pkRevitMisc_LinesPatterns" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
    ...
    [Autodesk.Revit.Attributes.Transaction(Autodesk.Revit.Attributes.TransactionMode.Manual)]
    public class DevInvoke_0090_pkRevitMisc_LinesPatterns : IExternalCommand  //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                {
                    RibbonSupportMethods.writeDebug("DevInvoke_0090_pkRevitMisc_LinesPatterns" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
