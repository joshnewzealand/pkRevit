...
namespace pkRevitRibbon
{
    ...
    public class Invoke_0040_pkRevitMisc_BrintToFront : IExternalCommand //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                string strCommandName_Method = "StartMethod_0040"; //<--------------------------------------------- edit here
                string strCommandName = "Entry_0040_pkRevitMisc"; //<--------------------------------------------- edit here
                ...
                if (!bool_Found)  
                {
                    RibbonSupportMethods.writeDebug("Invoke_0040_pkRevitMisc_OpenParentView" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
            ...
            {
                RibbonSupportMethods.writeDebug("Invoke_0040_pkRevitMisc_OpenParentView" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException, true);//<--------------------------------------------- edit here
            }
            finally
            {
            }
    ...
    [Autodesk.Revit.Attributes.Transaction(Autodesk.Revit.Attributes.TransactionMode.Manual)]
    public class DevInvoke_0040_pkRevitMisc_BrintToFront : IExternalCommand  //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                {
                    RibbonSupportMethods.writeDebug("DevInvoke_0040_pkRevitMisc_OpenParentView" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
            ...
            {
                string pathPreHeader = "DevInvoke_0040_pkRevitMisc_OpenParentView" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException + Environment.NewLine + Environment.NewLine;//<--------------------------------------------- edit here
