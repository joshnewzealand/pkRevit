    ...
    public class Invoke_0040_pkRevitMisc_BrintToFront : IExternalCommand //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                if (!bool_Found)  
                {
                    RibbonSupportMethods.writeDebug("Invoke_0040_pkRevitMisc_BrintToFront" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
    ...
    public class DevInvoke_0040_pkRevitMisc_BrintToFront : IExternalCommand  //<--------------------------------------------- edit here
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                {
                    RibbonSupportMethods.writeDebug("DevInvoke_0040_pkRevitMisc_BrintToFront" + Environment.NewLine + Environment.NewLine + "Count not find 'method', 'class' in 'file'" + Environment.NewLine
            ...
            {
                string pathPreHeader = "DevInvoke_0040_pkRevitMisc_BrintToFront" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException + Environment.NewLine + Environment.NewLine;//<--------------------------------------------- edit here
