...
namespace RevitTransformSliders
{
    ...
    public partial class Window1 : Window
    {
        ...
        public ThisApplication2 myThisApplication { get; set; }
        public ExternalCommandData commandData { get; set; }

        public Window1(ExternalCommandData cD, ThisApplication2 tA)
        {
            ...
            this.Top = pkRevitTransformSliders.Properties.Settings.Default.Top;
            this.Left = pkRevitTransformSliders.Properties.Settings.Default.Left;
            this.Height = pkRevitTransformSliders.Properties.Settings.Default.Height;
            this.Width = pkRevitTransformSliders.Properties.Settings.Default.Width;
            myIntUpDown_Middle2.Value = pkRevitTransformSliders.Properties.Settings.Default.LastMiddle;
            myIntUpDown_A.Value = pkRevitTransformSliders.Properties.Settings.Default.LastA;
            myIntUpDown_B.Value = pkRevitTransformSliders.Properties.Settings.Default.LastB;
        ...
        {
            pkRevitTransformSliders.Properties.Settings.Default.Top = this.Top;
            pkRevitTransformSliders.Properties.Settings.Default.Left = this.Left;
            pkRevitTransformSliders.Properties.Settings.Default.Height = this.Height;
            pkRevitTransformSliders.Properties.Settings.Default.Width = this.Width;
            pkRevitTransformSliders.Properties.Settings.Default.LastMiddle = myIntUpDown_Middle2.Value.Value;
            pkRevitTransformSliders.Properties.Settings.Default.LastA = myIntUpDown_A.Value.Value;
            pkRevitTransformSliders.Properties.Settings.Default.LastB = myIntUpDown_B.Value.Value;
            ...
            pkRevitTransformSliders.Properties.Settings.Default.Save();
        }
        ...
        //    catch (Exception ex)
        //    {
        //        _952_PRLoogleClassLibrary2.DatabaseMethods.writeDebug("myCopy_Click" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException, true);
        //    }
        //    finally
        //    {
        //    }
        ...
        //    catch (Exception ex)
        //    {
        //        _952_PRLoogleClassLibrary2.DatabaseMethods.writeDebug("myDelete_Click" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException, true);
        //    }
        //    finally
        //    {
        //    }
        ...
        private void myWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                _952_PRLoogleClassLibrary2.DatabaseMethods.writeDebug("myWindow_Loaded" + Environment.NewLine + ex.Message + Environment.NewLine + ex.InnerException, true);
            }
            finally
            {
            }
