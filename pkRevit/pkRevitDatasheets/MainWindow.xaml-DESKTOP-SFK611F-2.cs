    ...
    public partial class MainWindow : Window
    {
        ...
        private void RequestNavigate_AndStart()
        {
            ...
            switch (str_CurrentModeOfExplorer) /// str_CurrentModeOfExplorer = "ModeCategory"
            {
                ...
                case "ModeSchedule":
                    ...
                    List<Tuple<Int64, string>> listTuple_String = listDataRow.Select(x => new Tuple<Int64, string>((Int64)x["ScheduleID"], (string)x["ScheduleName"])).ToList();
        ...
        private void btn_rename_explorer_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                dict_GuidToAlias[((KeyValuePair<Guid, string>)lb_Explorer.SelectedItems[0]).Key] = s_NewAliasName;
                Stream stream = new FileStream(string_Default_GuidToAlias, FileMode.Create, FileAccess.Write);
                DataContractSerializer serializer = new DataContractSerializer(typeof(Dictionary<Guid, string>));  //four of four
                serializer.WriteObject(stream, dict_GuidToAlias); stream.Close();
        ...
        private void RemoveFilters_UsedOnUnisolate_And_RemoveFilterButton()
        {
            ...
            ModeProjectHyperLinks_AllSchedules();
        }

        private void ModeProjectHyperLinks_AllSchedules()
        {
        ...
        private void onDirectorySwitch_OrFirstRender()
        {
            ...
            try
            {
                ...
                model2.Files2 = new List<string>() { @"C:\Users\Joshua\Desktop\New folder (3)\sfd.sdf" }.ToArray();
                ...
                */
                ...
                RequestNavigate_AndStart();
                changing_RadioButtons_Codally(Properties.Settings.Default.str_carryOverCategory, false);//<-- the row filter is triggered on this event
                ...
                foreach (var path in file_pathes)
                {
                    if (!System.IO.Directory.Exists(path))
                    {
                        ...
                        if(false)
                        {
                            ...
                            Bitmap bitmap = FileToIconConverter.resizeImage(shellobject.Thumbnail.Bitmap, new System.Drawing.Size(256, 256), 0);

                            ///////////shellobject.Thumbnail.Bitmap.Save("C:\\img.jpg", ImageFormat.Jpeg); 

                            ////Bitmap newBitmap = new Bitmap(bitmap);
                            ////bitmap.Dispose();
                            ////bitmap = null;
                            ////newBitmap.Save("C:\\img.jpg", ImageFormat.Jpeg);

                            ////string outputFileName = @"C:\Users\Joshua\Desktop\New folder (3)\sfd.sdf";
                            ...
                            Stream stream = new FileStream(@"C:\Users\Joshua\Desktop\New folder (3)\sfd2.xml", FileMode.Create, FileAccess.Write);
                            DataContractSerializer serializer = new DataContractSerializer(typeof(Dictionary<string, Bitmap>));  //four of four
                            serializer.WriteObject(stream, imageDictionary); stream.Close();

                            //////////XDocument xdocument = new XDocument(new XDeclaration("1.0", "utf-8", "yes"));
                            //////////XElement myroot = new XElement("Images");

                            //////////xdocument.Add(myroot);

                            //////TypeConverter converter = TypeDescriptor.GetConverter(typeof(Bitmap));
                            //////XElement img = new XElement("image",
                            //////    Convert.ToBase64String(
                            //////        (byte[])converter.ConvertTo(bitmap, typeof(byte[]))));



                            //////////xdocument.Element("Images").Add(img);
                            //////////xdocument.Element("Images").Add(img);

                            //////////xdocument.Save(@"C:\Users\Joshua\Desktop\New folder (3)\sfd2.xml");

                            //////using (StringWriter sw = new StringWriter())
                            //////{
                            //////    img.Save(sw);
                            //////    // Console.WriteLine(sw.ToString());
                            //////    sw.Write(@"C:\Users\Joshua\Desktop\New folder (3)\sfd2.sdf");
                            //////}
                        }
